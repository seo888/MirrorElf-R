...
# 解压下载的 tar 文件，并将解压后的目录命名为 "MirrorElf_New"
echo "正在解压 $TAR_FILE..."
tar -xzf "$TAR_FILE" --one-top-level=MirrorElf_New --strip-components=1
...
new="/www/MirrorElf_New/Mirror-Elf-Rust"
old="/www/MirrorElf/Mirror-Elf-Rust"
